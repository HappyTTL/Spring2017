...
% \reminder{You might want to change the following to: We analyzed, we investigated}
 ...
 %To incorporate both autocorrelation and cross-correlation, the simulation complexity will increase in dramatic order. 
